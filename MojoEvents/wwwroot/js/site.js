...
$(".toggle-dropdown").click(function () {
    let dropdownMenu = $(this).parent().find(".dropdown");
    dropdownMenu.delay(100).slideToggle(400, () => {
        if ($(dropdownMenu[0]).attr("changed")) dropdownMenu[0].submit();
    });
});